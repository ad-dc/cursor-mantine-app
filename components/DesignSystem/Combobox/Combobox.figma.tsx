...
// Main connection — targets the "Ⓜ️ ComboBox" component (1233:2364).
//
// Identical to Select in Figma — a single component wrapping an
// Input/Text Input instance. All props are read via nestedProps.
figma.connect(
  Combobox,
  'https://www.figma.com/design/rXvD5jPC1i02ZIma87Qcbl/ADDS-Admin-Mantine-Core?node-id=1233-2364',
  {
    props: {
