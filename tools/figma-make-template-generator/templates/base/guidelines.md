...
- Import Mantine from bare specifiers:
  - `@mantine/core@9`, `@mantine/hooks@9`, add others as needed
...
- Dates: `@mantine/dates@9` is enabled with `DatesProvider`; `dayjs@1` is included for parsing/formatting (date values use ISO date strings per Mantine 8+).
